 ...
 */
    ...
    var _focus_pos = 0;
    var _focus_max_length = _focus_num * 955;
    var _focus_li_length = 955;
    var _focus_dsq = null;
    ...
    jQuery(function(){
        jQuery('.imagesWrapper').find('dd').each(function(){
            var dd  = this;
            jQuery(dd).mouseover(function(){
                jQuery(dd).find('.mask').animate({bottom: "0px"}, 100 );
                jQuery(dd).find('.content').animate({ bottom: "0px"}, 100 );
            }).mouseleave(function(){
                        jQuery(dd).find('.mask').animate({bottom: "-50px"}, 100 );
                        jQuery(dd).find('.content').animate({bottom: "-50px"}, 100 );
                    });
        });
    });